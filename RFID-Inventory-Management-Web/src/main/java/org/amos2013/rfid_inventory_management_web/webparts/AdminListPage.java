 ...
 */
public class AdminListPage extends MainPage 
{	
	 ...
	 */
	public AdminListPage(final PageParameters pageParameter) throws IOException
	{
		add(new DatabaseAccessAdminListForm("databaseAccessAdminListForm", pageParameter));
	}
}