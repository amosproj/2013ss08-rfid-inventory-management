 ...
 */
public class AdminEmployeeEditPageTest
{
	...
	/**
	 * tests if the {@link AdminEmployeeEditPage} homepage renders
	 */
	@Test
	public void homepageRendersSuccessfully()
	{
		//start and render the test page without page parameters
		wicketTester.startPage(AdminEmployeeEditPage.class);
		...
		wicketTester.startPage(AdminEmployeeEditPage.class, pageParameters);
		//assert rendered page class
		wicketTester.assertRenderedPage(AdminEmployeePage.class);
	}
}
